...
const cspDirectives = [
  ...
  "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://pagead2.googlesyndication.com https://clerk.resumeflow.harshithkumar.in https://challenges.cloudflare.com wss://*.convex.cloud https://*.convex.cloud https://ep1.adtrafficquality.google https://clerk-telemetry.com https://www.termsfeed.com https://*.razorpay.com",
];
