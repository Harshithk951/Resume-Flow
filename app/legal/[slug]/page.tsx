      ...
      <div className="space-y-6 text-xs md:text-sm">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-3 text-slate-600">
            ...
            <li><strong className="text-slate-800">Website</strong> refers to Resume Flow, accessible from <a href="https://resume-flow-bay.vercel.app" target="_blank" rel="noopener noreferrer" className="text-rose-600 hover:underline font-medium">https://resume-flow-bay.vercel.app</a>.</li>
        ...
        <section className="space-y-3">
          ...
          <p className="text-slate-600 leading-relaxed">If you have any questions about this Privacy Policy, You can contact us by visiting our website: <a href="https://resume-flow-bay.vercel.app" target="_blank" rel="noopener noreferrer" className="text-rose-600 hover:underline font-medium">https://resume-flow-bay.vercel.app</a>.</p>
        </section>
      </div>
    ),
  },
