...
function ResumeBuilderPageContent() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 h-[calc(100vh-8rem)] w-full gap-8 bg-slate-50">
      {/* LEFT COLUMN: EDITING FORM (5 columns) */}
      <div className="lg:col-span-6 bg-white border border-slate-200/85 rounded-3xl p-6 flex flex-col h-full overflow-hidden shadow-sm">
        {/* Section tabs */}
        <div className="flex gap-1.5 border-b border-slate-100 pb-3 mb-6 overflow-x-auto shrink-0 scrollbar-none">
          ...
          <AnimatePresence mode="wait">
            ...
            {activeSection === "contact" && (
              <motion.div
                ...
                className="space-y-4"
              >
                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-tight mb-2">Personal Information</h3>
            ...
            {activeSection === "education" && (
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-sm font-bold text-slate-800 uppercase tracking-tight">Education Records</h3>
                  <button
                    type="button"
                    onClick={addEducation}
                    className="px-3 py-1 rounded-xl bg-slate-100 hover:bg-slate-200 text-[11px] font-bold text-slate-700 transition-colors flex items-center gap-1"
                  >
                    <Plus className="w-3.5 h-3.5" /> Add
                  </button>
                </div>
                {profile.education.map((edu: any, index: number) => (
                  <div key={index} className="p-4 border border-slate-200/60 rounded-2xl space-y-3 relative bg-slate-50/20">
                    <button
                      type="button"
            ...
            {activeSection === "experience" && (
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-sm font-bold text-slate-800 uppercase tracking-tight">Work Experience</h3>
                  <button
                    type="button"
                ...
                {profile.experience.map((exp: any, index: number) => (
                  <div key={index} className="p-4 border border-slate-200/60 rounded-2xl space-y-3 relative bg-slate-50/20">
                    ...
                    <div className="flex flex-col gap-1">
                      <label className="text-[10px] font-bold text-slate-400 uppercase">Bullet Points (Comma separated)</label>
                      <textarea
                        rows={3}
            ...
            {activeSection === "projects" && (
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-sm font-bold text-slate-800 uppercase tracking-tight">Personal & Group Projects</h3>
                  <button
                    type="button"
                    onClick={addProject}
                    className="px-3 py-1 rounded-xl bg-slate-100 hover:bg-slate-200 text-[11px] font-bold text-slate-700 transition-colors flex items-center gap-1"
            ...
            {activeSection === "skills" && (
              <motion.div
                ...
                className="space-y-4"
              >
                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-tight mb-2">Technical Skills</h3>
                <div className="flex flex-col gap-1.5">
            ...
            {activeSection === "extras" && (
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-sm font-bold text-slate-800 uppercase tracking-tight">Certifications</h3>
                  <button
                    type="button"
        ...
        {/* Action Footer */}
        <div className="border-t border-slate-100 pt-4 mt-6 flex justify-between items-center shrink-0">
      ...
      <div className="lg:col-span-6 flex flex-col h-full bg-white border border-slate-200/85 rounded-3xl p-6 shadow-sm overflow-hidden">
        {/* Workspace Toolbar */}
        <div className="flex justify-between items-center border-b border-slate-100 pb-4 mb-6 shrink-0 gap-4">
          <div className="flex items-center gap-3">
            <select
              value={activeTemplate}
              onChange={(e) => setActiveTemplate(e.target.value)}
              className="text-xs border border-slate-200 p-2.5 rounded-xl font-bold bg-white text-slate-700 focus:outline-none focus:border-rose-500 cursor-pointer"
            >
