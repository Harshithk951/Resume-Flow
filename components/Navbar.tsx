  ...
  return (
    <nav
      className={`sticky top-0 z-50 transition-colors duration-300 transform-gpu ${
        scrolled
          ? "bg-white/95 backdrop-blur-xl shadow-sm border-b border-slate-900/10"
      ...
      <div className="max-w-[1280px] mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {templatesOpen && (
              <div className="absolute left-0 top-full mt-2 w-52 rounded-xl border border-slate-900/10 bg-white/95 backdrop-blur-lg py-1.5 shadow-lg">
                <Link
                  href={templatesHref}
