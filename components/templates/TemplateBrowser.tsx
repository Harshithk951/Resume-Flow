...
export default function TemplateBrowser() {
  ...
  return (
    <div className="flex min-h-full flex-col bg-slate-50 -m-6 md:-m-8">
      {/* Header Pill Selector */}
      <header className="z-20 flex h-14 shrink-0 items-center justify-center border-b border-slate-200 bg-white px-4 md:px-6 shadow-sm">
      ...
      <div className="flex min-h-0 flex-1 flex-col lg:flex-row overflow-hidden">
        {/* SIDEBAR EDIT PANEL */}
        <aside className="flex w-full shrink-0 flex-col border-b border-slate-200 bg-white lg:w-[380px] lg:border-b-0 lg:border-r xl:w-[420px] h-full overflow-hidden">
          
          {/* Sub-navigation for Editing Form Sections */}
          {mainMode === "edit" && (
            <div className="flex gap-1 border-b border-slate-100 px-4 pt-3 overflow-x-auto scrollbar-none shrink-0">
              {([
              ...
              <AnimatePresence mode="wait">
                ...
                {activeSection === "contact" && (
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider mb-2">Personal Information</h3>
                    <div className="grid grid-cols-1 gap-4">
                      <div className="flex flex-col gap-1.5">
                        ...
                        <input
                          ...
                          className="px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-rose-500 transition-all text-sm bg-slate-50/50"
                    ...
                    <div className="flex flex-col gap-1.5 mt-2">
                      ...
                      <textarea
                        ...
                        className="px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-rose-500 transition-all text-sm bg-slate-50/50 resize-none"
                ...
                {activeSection === "education" && (
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider">Education Records</h3>
                      <button
                        type="button"
                        onClick={addEducation}
                        className="px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-[10px] font-bold text-slate-700 transition-colors flex items-center gap-1"
                      >
                        <Plus className="w-3.5 h-3.5" /> Add New
                      </button>
                    </div>
                    {profile.education.map((edu: any, index: number) => (
                      <div key={index} className="p-4 border border-slate-200/80 rounded-2xl space-y-3.5 relative bg-slate-50/20 shadow-sm">
                        <button
                          type="button"
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <input
                            ...
                            className="px-3 py-2 rounded-lg border border-slate-200 bg-white text-xs focus:outline-none focus:border-rose-500"
                    ...
                    {profile.education.length === 0 && (
                      <p className="text-center py-8 text-xs text-slate-400">No education records added yet.</p>
                    )}
                  </motion.div>
                )}
                ...
                {activeSection === "experience" && (
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider">Work Experience</h3>
                      <button
                        type="button"
                    ...
                    {profile.experience.map((exp: any, index: number) => (
                      <div key={index} className="p-4 border border-slate-200/80 rounded-2xl space-y-3.5 relative bg-slate-50/20 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="text-[10px] font-bold text-slate-400 uppercase">Bullet Points (New line separated)</label>
                          <textarea
                            rows={4}
                            value={exp.bullets?.join("\n")}
                            onChange={(e) => updateExperience(index, "bullets", e.target.value.split("\n"))}
                            className="px-3 py-2 rounded-lg border border-slate-200 bg-white text-xs focus:outline-none focus:border-rose-500 resize-none leading-relaxed"
                    ...
                    {profile.experience.length === 0 && (
                      <p className="text-center py-8 text-xs text-slate-400">No work experience added yet.</p>
                    )}
                  </motion.div>
                )}
                ...
                {activeSection === "projects" && (
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider">Personal & Group Projects</h3>
                      <button
                        type="button"
                        onClick={addProject}
                        className="px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-[10px] font-bold text-slate-700 transition-colors flex items-center gap-1"
                    ...
                    {profile.projects.map((proj: any, index: number) => (
                      <div key={index} className="p-4 border border-slate-200/80 rounded-2xl space-y-3.5 relative bg-slate-50/20 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          <label className="text-[10px] font-bold text-slate-400 uppercase">Github / Live Link</label>
                          <input
                            type="url"
                            value={proj.link}
                    ...
                    {profile.projects.length === 0 && (
                      <p className="text-center py-8 text-xs text-slate-400">No projects added yet.</p>
                    )}
                  </motion.div>
                )}
                ...
                {activeSection === "skills" && (
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider mb-2">Technical Skills</h3>
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold text-slate-500">Programming Languages (Comma separated)</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold text-slate-500">Frameworks & Libraries (Comma separated)</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold text-slate-500">Tools, Cloud & DevOps (Comma separated)</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold text-slate-500">Databases (Comma separated)</label>
                      <input
                        type="text"
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold text-slate-500">Core CS Concepts (Comma separated)</label>
                      <input
                        type="text"
                ...
                {activeSection === "extras" && (
                  ...
                  >
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wider">Certifications</h3>
                      <button
                        type="button"
                    ...
                    {(profile.certifications || []).map((cert: any, index: number) => (
                      <div key={index} className="p-4 border border-slate-200/80 rounded-2xl space-y-3 relative bg-slate-50/20 shadow-sm">
                        <button
                          type="button"
                    ...
                    {(profile.certifications || []).length === 0 && (
                      <p className="text-center py-8 text-xs text-slate-400">No certifications added yet.</p>
                    )}
                  </motion.div>
                )}
              </AnimatePresence>
          ...
          <div className="border-t border-slate-200/80 p-4 shrink-0 flex flex-col gap-2.5 bg-slate-50/40">
